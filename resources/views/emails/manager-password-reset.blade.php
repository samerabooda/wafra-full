...
<title>إعادة تعيين كلمة المرور — Wafra Gulf</title>
<style>
  ...
  .header { background:linear-gradient(135deg,#e67e22,#c0392b); padding:30px 28px; text-align:center; }
  ...
  .pw-value { color:#c0392b; font-size:16px; letter-spacing:1px; }
...
<div class="wrap">
  <div class="header">
    ...
    <p>Password Reset — Wafra Gulf</p>
  </div>
  <div class="body">
    <div class="greeting">مرحباً {{ $manager->name }}،</div>
    <div class="sub">
      تم إعادة تعيين كلمة مرورك من قِبَل مدير النظام. استخدم كلمة المرور الجديدة أدناه لتسجيل الدخول.<br>
      <span style="font-size:11px;color:#8aa3b5">Your password has been reset by an administrator. Use the new password below to log in.</span>
    </div>
    ...
    <div class="creds-box">
      ...
      <div class="cred-row">
        <span class="cred-label">كلمة المرور الجديدة / New Password</span>
        <span class="cred-value pw-value">{{ $newPassword }}</span>
      </div>
    </div>

    <div class="notice">
      ⚠️ <strong>هذه كلمة مرور مؤقتة.</strong> سيُطلب منك تغييرها عند تسجيل الدخول.<br>
      <span style="font-size:11px">This is a temporary password. You will be required to change it upon login.</span>
    </div>
  ...
  <div class="footer">
    ...
    {{ config('app.url') }}<br>
    <span style="color:#b0bec5">إذا لم تتوقع هذا البريد، يُرجى التواصل مع المدير الفني.</span>
  </div>
</div>
</body>
</html>
